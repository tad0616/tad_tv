...
$GLOBALS['xoopsOption']['template_main'] = 'tad_tv_index.tpl';
...
function list_tad_tv($tad_tv_sn = '')
{
    ...
    while (list($tad_tv_cate_sn, $tad_tv_cate_title) = $xoopsDB->fetchRow($result)) {
        ...
        while (false !== ($all = $xoopsDB->fetchArray($result2))) {
            ...
            //將是/否選項轉換為圖示
            $tad_tv_enable = 1 == $tad_tv_enable ? '<img src="' . XOOPS_URL . '/modules/tad_tv/images/yes.gif" alt="' . _YES . '" title="' . _YES . '">' : '<img src="' . XOOPS_URL . '/modules/tad_tv/images/no.gif" alt="' . _NO . '" title="' . _NO . '">';
